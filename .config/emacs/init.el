...
(custom-set-variables
 ...
 '(package-selected-packages
   '(graphviz-dot-mode evil-owl haskell-mode cuda-mode flycheck-mypy cmake-mode yasnippet which-key vterm visual-fill-column use-package undo-tree rainbow-delimiters python-mode popup pkg-info pipenv org-roam org-noter-pdftools org-bullets no-littering lsp-ui lsp-ivy linum-relative ivy-rich ivy-prescient helpful gruber-darker-theme general forge flycheck evil-surround evil-nerd-commenter evil-collection eterm-256color eshell-git-prompt ein editorconfig doom-themes doom-modeline djvu dired-single dired-open dired-hide-dotfiles dashboard dap-mode counsel-projectile company-box command-log-mode clippy auto-package-update auctex all-the-icons-dired))
 '(pdf-tools-handle-upgrades t))
(custom-set-faces
